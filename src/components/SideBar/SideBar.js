  ...
  render() {
    return (
      <aside className='SideBar module'>
        <form className="SideBar-filter-form" onSubmit={this.handleSubmit}>
          <fieldset className="Sidebar-category">
            <legend className="SideBar-category-label">Sort:</legend>
            <select id="sort" onChange={this.handleSelect}>
          ...
          <fieldset className="Sidebar-category">
            ...
            <div className="checkbox-container">
              <input type="checkbox" className="type-checkbox" id="sport" name="sport" onChange={this.handleType}/>
